package com.generation.BlogDaGabs.Configuration;
	...
	public OpenAPI springOpenAPI() {
		return new OpenAPI()
				.info(new Info()
						...
						.contact(new Contact()
								.name("Github gabselaalcantara")
								.url("https://github.com/gabselaalcantara/")
								.email("gabriellaalcantarasz@gmail.com")))
						.externalDocs(new ExternalDocumentation()
						.description("Github Project")
						.url("https://github.com/gabselaalcantara/BlogDaGabs"));
	}
